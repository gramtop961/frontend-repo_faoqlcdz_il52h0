    ...
    <section className="relative min-h-[90vh] w-full overflow-hidden">
      ...
      <div className="relative z-10 mx-auto max-w-7xl px-6 pt-40 pb-24 flex flex-col items-start">
        ...
        <motion.h1
          ...
          className="mt-6 text-5xl sm:text-6xl lg:text-7xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-b from-white to-white/70"
        >
        ...
        <div className="mt-8 flex flex-wrap items-center gap-3">
          <motion.a
            ...
            whileTap={{ scale: 0.99 }}
            className="inline-flex items-center justify-center rounded-xl bg-gradient-to-r from-purple-500 to-pink-500 px-5 py-3 text-sm font-medium text-white shadow-lg shadow-purple-500/30"
          >
            Start a project
          </motion.a>
          <motion.a
            ...
            whileHover={{ y: -2 }}
            whileTap={{ y: 0 }}
            className="inline-flex items-center justify-center rounded-xl border border-white/20 bg-white/10 px-5 py-3 text-sm font-medium text-white/90 backdrop-blur hover:bg-white/15"
          >
            See our work
          </motion.a>
        </div>
      ...
      <motion.div
        ...
        className="pointer-events-none absolute inset-0 bg-[radial-gradient(1200px_500px_at_50%_-50%,rgba(168,85,247,0.35),transparent)]"
      />
